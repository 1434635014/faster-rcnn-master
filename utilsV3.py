...
#        rpn_bboxes = []
    ...
    def random_image(self, image_size):
        ...
        red = np.ones((self.image_size[0], self.image_size[0],1))*30
        green = np.ones((self.image_size[0], self.image_size[0],1))*60
        blue = np.ones((self.image_size[0], self.image_size[0],1))*90
...
config = Config()
dataset = shapeData([320, 320], config=config)
